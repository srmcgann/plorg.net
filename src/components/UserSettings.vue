    ...
    updateAvatar(){
      ...
      .then(data => {
        if(data[0]){
          ...
          this.state.users[this.state.loggedinUserHash].avatar = this.state.loggedinUserAvatar
    ...
    updateUserName(){
      ...
      .then(data => {
        if(data[0]){
          ...
          this.state.users[this.state.loggedinUserHash].name = this.state.loggedinUserName
